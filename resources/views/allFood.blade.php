...
<body>
        <div style="background-color: #FFF0DD;">
            ...
            <div style="background-color:#B0464A">
                <div class="container py-5" style="margin-top: 50px">
                <form action="/allFood" method="post" class="mb-4">
                    @csrf
                    <div class="input-group pt-5">
                        <input type="text" name="cari" class="form-control" placeholder="Dimana kamu hari ini? Ayo Jajan!!" value="{{ request()->input('search') }}">
